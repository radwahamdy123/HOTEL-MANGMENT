<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="REGISTRATION.aspx.cs" Inherits="HOTEL_MANGMENT.REGISTRATION" %>
...
<body bgcolor ="#CCCCCC">
    <form id="form2" runat="server">
        <div>
            <asp:Label ID="Label" runat="server" Font-Names="Monotype Corsiva" Font-Size="XX-Large" ForeColor="black" Text="Welcome to our hotel please, fill the registration form:"></asp:Label>
            <br />
            <br />
            <br />
        </div>
